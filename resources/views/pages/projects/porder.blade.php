                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div id="automations" class="specifications">
                                            ...
                                            <textarea minlength="5" id="Details" name="edetails" placeholder="Details" required="required"
                                                ...
                                                <table id="Laser">
                                                    <tr>
                                                        ...
                                                        <td id="laserCuttingtd" class="laserCuttingtd">
                                                            <div class="currencyinput">$</div>
                                                            <input type="number" id="laserCutting" name="laserCutting"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td id="CNCtd" class="CNCtd">
                                                            <div class="currencyinput">$</div>
                                                            <input type="number" id="CNC" name="CNC"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td id="Tornatd" class="Tornatd">
                                                            <div class="currencyinput">$</div>
                                                            <input type="number" id="Torna" name="Torna"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td id="Assemblingtd" class="Assemblingtd">
                                                            <div class="currencyinput">$</div>
                                                            <input type="number" id="Assembling" name="Assembling"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td id="eandalbltd" class="eandalbltd">
                                                            <div class="currencyinput">$</div>
                                                            <input type="number" id="eanda" name="eanda"
